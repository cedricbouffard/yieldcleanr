---
title: "test4.csv - Test Data (File 4)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{test4.csv - Test Data (File 4)}
...
This file contains test data 4 for yield cleaning.
...
ggplot() +
  ...
  theme_minimal() +
  labs(title = "Raw Data - test4.csv", subtitle = "Before cleaning")
```
...
ggplot() +
  ...
  theme_minimal() +
  labs(title = "Cleaned Data - test4.csv", subtitle = "After AYCE")
```
