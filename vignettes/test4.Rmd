---
title: "test4.csv - Données de Test (Fichier 4)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{test4.csv - Données de Test (Fichier 4)}
...
Ce fichier contient des données de test 4 pour le nettoyage des rendements.
...
```{r raw-data}
file_path <- system.file("extdata", "test4.csv", package = "yieldcleanr")
...
ggplot() +
  ...
  theme_minimal() +
  labs(title = "Données Brutes - test4.csv", subtitle = "Avant nettoyage")
```
...
ggplot() +
  ...
  theme_minimal() +
  labs(title = "Données Nettoyées - test4.csv", subtitle = "Après AYCE")
```
