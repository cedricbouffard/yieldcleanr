---
title: "test3.csv - Données de Test (Fichier 3)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{test3.csv - Données de Test (Fichier 3)}
...
Ce fichier contient des données de test 3 pour le nettoyage des rendements.
...
ggplot() +
  ...
  theme_minimal() +
  labs(title = "Données Brutes - test3.csv", subtitle = "Avant nettoyage")
```
...
ggplot() +
  ...
  theme_minimal() +
  labs(title = "Données Nettoyées - test3.csv", subtitle = "Après AYCE")
```
