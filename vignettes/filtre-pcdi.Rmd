...
cat("Score Moran moyen au délai optimal:", 
    round(pcdi_result$rsc_values$mean_rsc[pcdi_result$rsc_values$delay == pcdi_result$optimal_delay], 4), "\n")
```
