...
# Étape 2: Filtre position (hors champ) - AVANT delay adjustment
data_s1 <- filter_position_outliers(data_s1)$data

# Étape 3: Delay Adjustment (sur Flow, pas sur Yield)
...
# Étape 4: Conversion en rendement APRÈS delay adjustment
data_s1 <- convert_flow_to_yield(data_s1)

# Étape 5: Seuils automatiques
...
# Étape 2: Filtre position (hors champ) - AVANT delay adjustment
data_s2 <- filter_position_outliers(data_s2)$data

# Étape 3: Delay Adjustment avec délai important (sur Flow, pas sur Yield)
delay_result_s2 <- optimize_delays(data_s2, type = "flow", delay_range = -25:25, n_iterations = 10, noise_level = 0.03)
...
# Filtre position AVANT delay adjustment
data_s3 <- filter_position_outliers(data_s3)$data

# Delay Adjustment sur Flow (pas sur Yield)
delay_result_s3 <- optimize_delays(data_s3, type = "flow", delay_range = -25:25, n_iterations = 10, noise_level = 0.03)
...
# Filtre position AVANT delay adjustment
data_s4 <- filter_position_outliers(data_s4)$data

# Delay Adjustment sur Flow (pas sur Yield)
delay_result_s4 <- optimize_delays(data_s4, type = "flow", delay_range = -25:25, n_iterations = 10, noise_level = 0.03)
