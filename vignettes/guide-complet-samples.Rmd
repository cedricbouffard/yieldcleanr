...
data_s1 <- filter_data(data_s1, type = "velocity", 
                       min_value = thresholds_s1$min_velocity, 
                       max_value = thresholds_s1$max_velocity)
...
data_s2 <- filter_data(data_s2, type = "velocity", 
                       min_value = thresholds_s2$min_velocity, 
                       max_value = thresholds_s2$max_velocity)
...
data_s3 <- data_s3 %>%
  filter_data(type = "velocity", 
              min_value = thresholds_s3$min_velocity, 
              max_value = thresholds_s3$max_velocity) %>%
...
data_s4 <- data_s4 %>%
  filter_data(type = "velocity", 
              min_value = thresholds_s4$min_velocity, 
              max_value = thresholds_s4$max_velocity) %>%
  filter_data(type = "moisture", n_std = 3) %>%
  detect_anomalies(type = "overlap", cellsize = 0.3, overlap_threshold = 0.5) %>%
  detect_anomalies(type = "local_sd", n_swaths = 5, lsd_limit = 3)
