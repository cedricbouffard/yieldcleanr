...
test_that(".translate_crop_to_french translates common crops", {
  expect_equal(.translate_crop_to_french("corn"), "Maïs")
  expect_equal(.translate_crop_to_french("maize"), "Maïs")
  expect_equal(.translate_crop_to_french("soybean"), "Soya")
  expect_equal(.translate_crop_to_french("wheat"), "Blé")
  expect_equal(.translate_crop_to_french("barley"), "Orge")
})
...
test_that(".translate_crop_to_french handles unknown crops", {
  expect_equal(.translate_crop_to_french("unknown_crop"), "unknown_crop")
  expect_equal(.translate_crop_to_french("custom"), "custom")
})
...
test_that(".translate_crop_to_french handles plurals", {
  expect_equal(.translate_crop_to_french("soybeans"), "Soya")
  expect_equal(.translate_crop_to_french("potatoes"), "Pomme de terre")
  expect_equal(.translate_crop_to_french("carrots"), "Carotte")
})
