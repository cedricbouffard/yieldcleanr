...
The `yieldcleanr` package includes example data files to test and
demonstrate yield data cleaning functionality.
...
For more detailed examples, see the main vignette
