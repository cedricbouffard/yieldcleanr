...
Le **PCDI (Position-Coordinate Delay Identification)** est un algorithme
sophistiqué qui détecte et corrige le délai temporel entre la mesure du
flux de grain et l’enregistrement de la position GPS. Ce délai,
typiquement de 2 à 15 secondes, peut créer des bandes obliques
...
Le PCDI utilise l’**indice de Moran** pour mesurer l’autocorrélation
spatiale du rendement. L’autocorrélation spatiale mesure dans quelle
mesure des points proches géographiquement ont des valeurs de rendement
similaires.
...
**Objectif du PCDI** : Maximiser l’indice de Moran en trouvant le délai
optimal qui aligne le flux avec la position.
...
#> Score Moran moyen au délai optimal: 0.6386
```
...
![](filtre-pcdi_files/figure-html/pcdi-plot-1.png)
...
![](filtre-pcdi_files/figure-html/pcdi-comparison-1.png)
...
![](filtre-pcdi_files/figure-html/pcdi-comparison-2.png)
...
![](filtre-pcdi_files/figure-html/pcdi-simulation-1.png)
...
![](filtre-pcdi_files/figure-html/pcdi-moran-effect-1.png)
...
Le PCDI est un outil puissant qui utilise l’autocorrélation spatiale
pour détecter et corriger les délais de synchronisation. En maximisant
l’indice de Moran, il aligne automatiquement le flux de grain avec la
position GPS, éliminant les artefacts visuels et améliorant la qualité
